...
import { Mail, FileText, Calendar, Gift, X, Home, LogOut, RefreshCw } from "lucide-react";
      ...
      <div className="p-4 border-b border-gray-200 dark:border-zinc-700 flex-shrink-0 sticky top-0 z-10 bg-white dark:bg-zinc-800">
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-lg font-bold text-gray-900 dark:text-white truncate">Applendium</h1>
